...
public interface ProductRepository extends JpaRepository<Product, Long>, JpaSpecificationExecutor<Product> {
    ...
    int updateCategoryForProducts(@org.springframework.data.repository.query.Param("oldCategoryId") Long oldCategoryId,
                                  @org.springframework.data.repository.query.Param("newCategory") flashdeal_api.entity.Category newCategory);
}
